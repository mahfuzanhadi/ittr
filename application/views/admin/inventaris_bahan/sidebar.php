...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseInventaris" aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-boxes"></i>
            <span>Inventaris</span>
        </a>
        <div id="collapseInventaris" class="collapse show" aria-labelledby="headingInventaris" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?= base_url('iobat'); ?>"><i class="fas fa-fw fa-pills"></i>&nbsp&nbspObat</a>
                <a class="collapse-item active" href="<?= base_url('ibahan'); ?>"><i class="fas fa-fw fa-briefcase-medical"></i>&nbsp&nbspAlat dan Bahan</a>
            </div>
        </div>
    </li>
