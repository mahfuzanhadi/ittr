                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <select class="custom-select custom-select-sm" name="dokter" id="dokter" readonly>
                                            <option value="<?= $this->session->userdata('id'); ?>" selected><?= $this->session->userdata('nama'); ?></option>
                                        </select>
