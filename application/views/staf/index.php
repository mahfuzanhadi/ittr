...
<div class="container-fluid">
    ...
    <div class="card" style="max-width: 560px; padding-top: 20px;">
        <center>
            <img src="<?= base_url('assets/img/profile/avatar.png'); ?>" height="240px" width="240px" style="margin-bottom: 30px">
            <div class="card-body" style="text-align : justify">
                <h5 class="card-title" style="text-align : center"><?= $staf['nama']; ?></h5>
                <p class="card-text">Email : <?= $staf['email']; ?></p>
                <p class="card-text">Alamat : <?= $staf['alamat']; ?></p>
                <p class="card-text">Tanggal lahir : <?= $staf['tanggal_lahir']; ?></p>
                <?php $umur = date('Y-m-d') - $staf['tanggal_lahir']; ?>
