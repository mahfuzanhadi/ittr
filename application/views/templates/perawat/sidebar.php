...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('perawat/dashboard'); ?>">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="<?= base_url('perawat/dashboard'); ?>">
