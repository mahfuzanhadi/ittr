            ...
            <form action="" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="tanggal_berlaku_str" id="datepicker" placeholder="Tanggal Berlaku STR" value="<?= set_value('tanggal_berlaku_str'); ?>" /> <small>(tahun-bulan-hari)</small>
