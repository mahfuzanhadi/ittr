            ...
            <form action="" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" name="tempat_lahir" placeholder="Tempat Lahir" value="<?= set_value('tempat_lahir'); ?>" />
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="no_sip" placeholder="No. SIP" value="<?= set_value('no_sip'); ?>" />
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="tanggal_berlaku_sip" id="datepicker" placeholder="Tanggal Berlaku SIP" value="<?= set_value('tanggal_berlaku_sip'); ?>" /> <small>(tahun-bulan-hari)</small>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="no_str" placeholder="No. STR" value="<?= set_value('no_str'); ?>" />
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="tanggal_berlaku_str" id="datepicker2" placeholder="Tanggal Berlaku STR" value="<?= set_value('tanggal_berlaku_str'); ?>" /> <small>(tahun-bulan-hari)</small>
