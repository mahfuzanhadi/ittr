            ...
            <form action="<?= base_url('iobat/update'); ?>" method="post" id="form_iobat">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input class="form-control" type="text" name="tgl_masuk" id="picker" placeholder="Tanggal Masuk" value="<?= $iobat['tgl_masuk'] ?>" /> <small>(tahun-bulan-hari)</small><br />
                ...
                <div class="form-row">
                    <div class="form-group col-sm-2">
                        ...
                        <input class="form-control" type="text" name="expired" id="datepicker" placeholder="Expired" value="<?= $iobat['expired'] ?>" /> <small>(tahun-bulan-hari)</small><br />
                        <span id="error_datepicker" class="text-danger"></span>
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="jumlah_masuk">Jumlah Masuk <font color="red">*</font></label>
                        <input class="form-control" type="text" name="jumlah_masuk" id="jumlah_masuk" placeholder="Jumlah Masuk " value="<?= $iobat['jumlah_masuk'] ?>" onkeypress="javascript:return isNumber(event)" />
