...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="post" id="transaksi_form" enctype="multipart/form-data" action="<?= base_url('transaksi/update/') . $transaksi['id_transaksi']; ?>">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <select class="itemName form-control form-control-sm" name="tindakan" id="tindakan">
                                        ...
                                        <?php foreach ($tindakan as $row) : ?>
                                            <?php if ($row->id_tindakan == $transaksi[0]['id_tindakan']) : ?>
                                                <option value="<?= $row->id_tindakan; ?>" selected><?= $row->nama; ?></option>
                                            <?php else : ?>
                                                <option value="<?= $row->id_tindakan; ?>"><?= $row->nama; ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
