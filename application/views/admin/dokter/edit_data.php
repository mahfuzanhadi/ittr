            ...
            <form action="" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="nama" placeholder="Nama" value="<?= $dokter['nama'] ?>" />
                        <small class="form-text text-danger"><?= form_error('nama'); ?></small>
                    </div>
                    <div class="form-group col-sm-3">
                        <label for="alamat">Alamat <font color="red">*</font></label>
                        <input class="form-control form-control-sm" name="alamat" placeholder="Alamat" value="<?= $dokter['alamat'] ?>" />
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" name="tempat_lahir" placeholder="Tempat Lahir" value="<?= $dokter['tempat_lahir'] ?>" />
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="tanggal_lahir" id="picker" placeholder="Tanggal Lahir" value="<?= $dokter['tanggal_lahir'] ?>" /> <small>(tahun-bulan-hari)</small>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="email" placeholder="E-mail" value="<?= $dokter['email'] ?>" />
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="no_telp" placeholder="No. Telp" value="<?= $dokter['no_telp'] ?>" />
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="no_sip" placeholder="No. SIP" value="<?= $dokter['no_sip'] ?>" />
                        <small class="form-text text-danger"><?= form_error('no_sip'); ?></small>
                    </div>
                    <div class="form-group col-sm-3">
                        <label for="tanggal_berlaku_sip">Tanggal Berlaku SIP <font color="red">*</font></label>
                        <!-- <input class="form-control form-control-sm" type="date" name="tanggal_berlaku_sip" placeholder="Tanggal berlaku_sip" value="<?= set_value('tanggal_berlaku_sip'); ?>" /> -->
                        <input class="form-control form-control-sm" type="text" name="tanggal_berlaku_sip" id="datepicker" placeholder="Tanggal Berlaku SIP" value="<?= $dokter['tanggal_berlaku_sip'] ?>" /> <small>(tahun-bulan-hari)</small>
                        <small class="form-text text-danger"><?= form_error('tanggal_berlaku_sip'); ?></small>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        <label for="no_str">No. STR <font color="red">*</font></label>
                        <input class="form-control form-control-sm" type="text" name="no_str" placeholder="No. STR" value="<?= $dokter['no_str'] ?>" />
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input class="form-control form-control-sm" type="text" name="tanggal_berlaku_str" id="datepicker2" placeholder="Tanggal Berlaku STR" value="<?= $dokter['tanggal_berlaku_str'] ?>" /> <small>(tahun-bulan-hari)</small>
